...
<!-- Docs nav ================================================== -->
      <div class="row">
        <div class="col-md-2">
          ...
          <BR>
          <img src="<?php echo site;?>/img/thijsdp.jpg" alt="Thijs De Paepe" class="img-thumbnail">
        </div>
          ...
          <div class="page-header">
            <h3>thijzer</h3>
             ...
             <p>
              ...
              I also develop on other projects, read more about it in <a href="<?php echo site;?>about#projects">the project</a> section. 
