...
/* home/index.twig */
class __TwigTemplate_ec0d8224b5a68cbdc19ee5f7799cca3478308868d4a7d47bc810ed8150bf3d1f extends Twig_Template
{
...
";
  ...
  <ul>
    <li><a href=\"";
            // line 65
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('url')->getCallable(), array("u_login")), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, call_user_func_array($this->env->getFilter('lng')->getCallable(), array("nav.login"))), "html", null, true);
            echo "</a></li>
    <li><a href=\"";
            // line 66
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('url')->getCallable(), array("register")), "html", null, true);
            echo "\">";
