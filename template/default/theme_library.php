...
<!-- Fav and touch icons -->
    <link rel="shortcut icon" href="<?php echo site;?>ico/favicon.png">
...
function notice($msg)
{
  ...
  if(!empty($msg['notice']))
  { ?>
    <div class="alert alert-success"><?php echo $msg['notice'];?></div>
  <?php }
  if(!empty($msg['errors']))
  { ?>
    <div class="alert alert-danger"><?php echo $msg['errors'];?></div>
  <?php }
